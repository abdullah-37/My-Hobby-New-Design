...
class JoinClubController extends GetxController {
  ...
  joinClub({required String clubId, required String referralCode,}) async {
    ...
    try {
      final res = await http.post(
        ...
        body: {'club_id': clubId, 'referral_code': referralCode},
      );

      debugPrint('Base Url: ${ApiUrl.baseUrl}${ApiUrl.getJoinClub}');
